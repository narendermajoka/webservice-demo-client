 ...
 * 
 */
@WebServiceClient(name = "ProductServiceImplService", targetNamespace = "http://impl.services.ws.idemia.com/", wsdlLocation = "http://localhost:8080/services/productService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTSERVICEIMPLSERVICE_QNAME = new QName("http://impl.services.ws.idemia.com/", "ProductServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/services/productService?wsdl");
    ...
    public ProductService getProductServiceImplPort() {
        return super.getPort(new QName("http://impl.services.ws.idemia.com/", "ProductServiceImplPort"), ProductService.class);
    }
    ...
    public ProductService getProductServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.services.ws.idemia.com/", "ProductServiceImplPort"), ProductService.class, features);
    }
